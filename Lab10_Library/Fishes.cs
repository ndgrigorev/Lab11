...
namespace Lab10_Library
{
    public class Fishes : Animals, IInit
    {
        ...
        {
            return $"Рыба: id: {Id.Number}, имя: {Name}, пол:{Gender}, возраст: {Age} лет, тип рыбы: {TypeOfFish}, кол-во плавников: {NumberOfFins}";
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            {
                return animal.Id.Number == Id.Number & animal.Name == Name && animal.Gender == Gender && animal.Age == Age && animal.TypeOfFish == TypeOfFish && animal.NumberOfFins == NumberOfFins;
            }
            else
            {
                return false;
