...
namespace Lab10_Library
{
    public class Cats : Mammals, IInit
    {
        ...
        {
            return $"Кошка: id: {Id.Number}, имя: {Name}, пол:{Gender}, возраст: {Age} лет, вес: {Weight} кг., порода: {Breed}, окрас: {Color}, длина хвоста: {TailLength} м.";
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            {
                return animal.Id.Number == Id.Number && animal.Name == Name && animal.Gender == Gender && animal.Age == Age && animal.Weight == Weight && animal.Breed == Breed && animal.Color == Color && animal.TailLength == TailLength;
            }
            else
            {
                return false;
