...
namespace Lab10_Library
{
    public class Mammals : Animals, IInit
    {
        ...
        {
            return $"Млекопитающее: id: {Id.Number}, имя: {Name}, пол:{Gender}, возраст: {Age} лет, вес: {Weight} кг.";
        }
        public override bool Equals(object obj)
        {
            if (obj is Mammals animal)
            {
                return animal.Id.Number == Id.Number && animal.Name == Name && animal.Gender == Gender && animal.Age == Age && animal.Weight == Weight;
            }
            else
            {
                return false;
